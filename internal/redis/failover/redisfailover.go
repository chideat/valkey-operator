...
var _ types.RedisFailoverInstance = (*Failover)(nil)
...
func (s *Failover) Arch() redis.RedisArch {
...
func (s *Failover) Version() redis.RedisVersion {
	if s == nil {
		return redis.RedisVersionUnknown
	}

	if version, err := redis.ParseRedisVersionFromImage(s.Spec.Image); err != nil {
...
func (s *Failover) Masters() []redis.RedisNode {
...
func (s *Failover) Nodes() []redis.RedisNode {
	if s == nil || s.replication == nil {
		return nil
	}
...
func (s *Failover) Users() (us acl.Users) {
	if s == nil {
		return nil
	}
...
func (s *Failover) loadUsers(ctx context.Context) (acl.Users, error) {
	var (
