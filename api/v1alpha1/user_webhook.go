...
// +kubebuilder:webhook:path=/mutate-valkey-buf-red-v1alpha1-user,mutating=true,failurePolicy=fail,sideEffects=None,groups=valkey.buf.red,resources=users,verbs=create;update,versions=v1alpha1,name=muser.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-valkey-buf-red-v1alpha1-user,mutating=false,failurePolicy=fail,sideEffects=None,groups=valkey.buf.red,resources=users,verbs=create;update,versions=v1alpha1,name=vuser.kb.io,admissionReviewVersions=v1
