...
func (_m *ClientSet) GetCluster(ctx context.Context, namespace string, name string) (*v1alpha1.Cluster, error) {
	ret := _m.Called(ctx, namespace, name)
...
func (_m *ClientSet) GetFailover(ctx context.Context, namespace string, name string) (*v1alpha1.Failover, error) {
	ret := _m.Called(ctx, namespace, name)
	...
	var r0 *v1alpha1.Failover
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v1alpha1.Failover, error)); ok {
		return rf(ctx, namespace, name)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v1alpha1.Failover); ok {
		r0 = rf(ctx, namespace, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Failover)
		}
	}
...
func (_m *ClientSet) GetSentinel(ctx context.Context, namespace string, name string) (*v1alpha1.Sentinel, error) {
	ret := _m.Called(ctx, namespace, name)
	...
	var r0 *v1alpha1.Sentinel
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v1alpha1.Sentinel, error)); ok {
		return rf(ctx, namespace, name)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v1alpha1.Sentinel); ok {
		r0 = rf(ctx, namespace, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Sentinel)
		}
	}
...
func (_m *ClientSet) ListFailovers(ctx context.Context, namespace string, opts client.ListOptions) (*v1alpha1.FailoverList, error) {
	...
	var r0 *v1alpha1.FailoverList
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, client.ListOptions) (*v1alpha1.FailoverList, error)); ok {
		return rf(ctx, namespace, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, client.ListOptions) *v1alpha1.FailoverList); ok {
		r0 = rf(ctx, namespace, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.FailoverList)
		}
	}
...
func (_m *ClientSet) ListSentinels(ctx context.Context, namespace string, opts client.ListOptions) (*v1alpha1.SentinelList, error) {
	ret := _m.Called(ctx, namespace, opts)
	...
	var r0 *v1alpha1.SentinelList
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, client.ListOptions) (*v1alpha1.SentinelList, error)); ok {
		return rf(ctx, namespace, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, client.ListOptions) *v1alpha1.SentinelList); ok {
		r0 = rf(ctx, namespace, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.SentinelList)
		}
	}
...
func (_m *ClientSet) UpdateCluster(ctx context.Context, inst *v1alpha1.Cluster) error {
...
func (_m *ClientSet) UpdateClusterStatus(ctx context.Context, inst *v1alpha1.Cluster) error {
	ret := _m.Called(ctx, inst)
...
func (_m *ClientSet) UpdateFailover(ctx context.Context, inst *v1alpha1.Failover) error {
	ret := _m.Called(ctx, inst)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha1.Failover) error); ok {
		r0 = rf(ctx, inst)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *ClientSet) UpdateFailoverStatus(ctx context.Context, inst *v1alpha1.Failover) error {
	ret := _m.Called(ctx, inst)
...
func (_m *ClientSet) UpdateSentinel(ctx context.Context, sen *v1alpha1.Sentinel) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha1.Sentinel) error); ok {
		r0 = rf(ctx, sen)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *ClientSet) UpdateSentinelStatus(ctx context.Context, inst *v1alpha1.Sentinel) error {
	ret := _m.Called(ctx, inst)
